...
//
// Since: TODO version
func NewGridWrapList(length func() int, createItem func() fyne.CanvasObject, updateItem func(widget.ListItemID, fyne.CanvasObject)) *GridWrapList {
...
func (l *GridWrapList) scrollTo(id widget.ListItemID) {
	if l.scroller == nil {
		return
	}
...
func (l *GridWrapList) Select(id widget.ListItemID) {
...
func (l *GridWrapList) Unselect(id widget.ListItemID) {
